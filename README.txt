...
Rationale is designed to run using the version of Tkinter provided with the latest version of Python.  It also requires the Csound Python library (preferably from the latest installation of Csound).  Both are free, cross-platform, open-source software, available as internet downloads.  If you install Python 2.5 or higher and Csound 5.10 or higher, Rationale should run without any further setup.  It has only been tested on Linux and Macintosh OSX.  Oh, and I guess Windows.
